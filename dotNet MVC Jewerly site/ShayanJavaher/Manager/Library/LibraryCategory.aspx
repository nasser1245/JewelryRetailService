<%@ Page Title="" Language="C#" MasterPageFile="~/Manager/ManagerMasterPage.master" AutoEventWireup="true" CodeFile="LibraryCategory.aspx.cs" Inherits="Manager_Library_LibraryCategory" %>
    ...
    function removeArticle(obj, Id) {
        if (confirm('آیا از حذف این عنوان اطمینان دارید؟')) {
            if (obj) {
                $.ajax({
                    type: "POST",
                    url: "LibraryCategory.aspx/DeleteArticle",
                    data: "{'Id':'" + Id + "'}",
  ...
  <div id="alert" class="hide">
    ...
    <div class="AllContent">
            ...
            <fieldset style = "width:98%">
                <legend>درج گروه کتاب</legend>
                <div class="FieldsKey">
                    <div class="LabelP">
                        عنوان</div>
                    <div class="ValueP">
                        <asp:TextBox ID="txtTitleLibraryCategory" runat="server"></asp:TextBox></div>
                    <div class="LabelP">
                    </div>
                    <div class="ValueP">
                    ...
                    <div class="ValueP">
                        <asp:Button ID="btnAddLibraryCategory" runat="server" Text="ثبت" OnClick="btnAddMenu_Click" />
                    </div>
                </div>
            </fieldset>
    ...
    <fieldset style= "width:98%">
        <legend>لیست گروه های کتاب</legend>
        <div class="FieldsKey">
        <div class="LabelP">
            جستجو</div>
        <div class="ValueP">
        
            <asp:TextBox ID="txtLibraryCategorySearch" runat="server"></asp:TextBox>
