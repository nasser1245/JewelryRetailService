...
public partial class Manager_UC_ucMemberList : System.Web.UI.UserControl
{
    ...
    private void BindPagingGrid()
    {
        try
        {
            ...
            if (Page.User.IsInRole("1") || ((HProtest_BLL.AccessLevel.AccessLevel)HttpContext.Current.Session["AccessLevel"]).ManagerAgent == true)           {
                using (System.Data.DataTable dtPagedArticles = MemberData.GetMemberList(txtUserName.Text, txtName.Text, txtFamily.Text, txtEmail.Text, "3",
