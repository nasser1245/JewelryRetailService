...
namespace ShayanDB_BLL
{
     public class Captcha
    {
        ...
        public void GenerateImage()
        {
            ...
            HatchBrush hatchBrush = new HatchBrush(HatchStyle.SmallConfetti, Color.FromArgb(114, 172, 236), Color.FromArgb(233, 223, 207));
        ...
        {
            string TextChars = "ACDEFGHJKLNPQRTUVXYZ2346789acdefghjknpqrtuvxz";
            StringBuilder sb = new StringBuilder(6);
            int maxLength = TextChars.Length;
            for (int n = 0; n <= 5; n++)
                sb.Append(TextChars.Substring(random.Next(maxLength), 1));
